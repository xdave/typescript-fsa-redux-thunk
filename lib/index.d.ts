 ...
 */
export declare const asyncFactory: <S>(create: ActionCreatorFactory) => <P, R, E = any>(type: string, worker: AsyncWorker<P, R extends void ? unknown : R extends PromiseLike<R> ? PromiseLike<R> : R, S>) => ThunkFunction<S, P, R extends void ? unknown : R extends PromiseLike<R> ? PromiseLike<R> : R, E>;
