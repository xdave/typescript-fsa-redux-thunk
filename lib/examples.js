...
var login = createAsync('Login', function (params, dispatch) { return __awaiter(void 0, void 0, void 0, function () {
    var url, options, res;
...
var reducer = typescript_fsa_reducers_1.reducerWithInitialState(initial)
    .case(changeTitle, function (state, title) { return (__assign(__assign({}, state), { title: title })); })
    .case(login.async.started, function (state) { return (__assign(__assign({}, state), { loggingIn: true, error: undefined })); })
    .case(login.async.failed, function (state, _a) {
    var error = _a.error;
    return (__assign(__assign({}, state), { loggingIn: false, error: error }));
})
    .case(login.async.done, function (state, _a) {
    var userToken = _a.result;
    return (__assign(__assign({}, state), { userToken: userToken, loggingIn: false, error: undefined }));
});
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, store.dispatch(login({
