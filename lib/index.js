 ...
 */
exports.asyncFactory = function (create) { return function (type, worker) { return (new /** @class */ (function () {
    function ThunkFunction() {
        var _this = this;
        this.async = create.async(type);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, worker(params, dispatch, getState)];
                        case 1:
                            result = _a.sent();
                            dispatch(this.async.done({ params: params, result: result }));
                            return [2 /*return*/, result];
                        case 2:
                            error_1 = _a.sent();
                            dispatch(this.async.failed({ params: params, error: error_1 }));
                            throw error_1;
