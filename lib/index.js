...
exports.asyncFactory = function (create) {
    return function (type, worker) {
        ...
        var fn = function (params) { return (function (dispatch, getState) { return __awaiter(void 0, void 0, void 0, function () {
            var result, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        dispatch(async.failed({ params: params, error: error_1 }));
                        throw error_1;
